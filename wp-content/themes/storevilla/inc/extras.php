...
if(class_exists( 'WP_Customize_control')) {
    ...
    class StoreVilla_Theme_Info_Custom_Control extends WP_Customize_Control {
        public function render_content(){ ?>
            <label>
                <div class="user_sticky_note">
                    <span class="sticky_info_row"><a class="button" href="http://demo.accesspressthemes.com/storevilla/" target="_blank">Live Demo</a>
                    <span class="sticky_info_row"><a class="button" href="http://doc.accesspressthemes.com/storevilla/" target="_blank">Documentation</a></span>
                    <span class="sticky_info_row"><a class="button" href="https://accesspressthemes.com/support/forum/themes/free-themes/storevilla/" target="_blank">Support Forum</a></span>
                    <span class="sticky_info_row"><a class="button" href="https://www.youtube.com/watch?v=XA_cuDNX2Q4&list=PLdSqn2S_qFxH6QD8Z9mQBbM6oGc1yKR-a" target="_blank">Video Tutorial</a></span>
                ...
                <span class="customize-text_editor_desc">                 
                    <ul class="admin-pro-feature-list">   
                        <li><span><?php _e('Next generation WooCommerce theme','storevilla'); ?> </span></li>
                        <li><span><?php _e('WordPress Live Customizer','storevilla'); ?> </span></li>
                        <li><span><?php _e('One Click Demo Import','storevilla'); ?> </span></li>
                        <li><span><?php _e('Unlimited theme colors ( Primary and secondary)','storevilla'); ?> </span></li>
                        <li><span><?php _e('Advanced typography settings','storevilla'); ?> </span></li>
                        <li><span><?php _e('Unlimited sliders Inbuilt sliders or Slider Revolution','storevilla'); ?> </span></li>
                        <li><span><?php _e('Configure product page/ shop unlimited','storevilla'); ?> </span></li>
                        <li><span><?php _e('Advanced product search','storevilla'); ?> </span></li>
                        <li><span><?php _e('Smart header','storevilla'); ?> </span></li>
                        <li><span><?php _e('Background configuration','storevilla'); ?> </span></li>
                        <li><span><?php _e('15+ Inbuilt custom widgets','storevilla'); ?> </span></li>
                        <li><span><?php _e('Highly configurable home page','storevilla'); ?> </span></li>
                        <li><span><?php _e('Three different horizontal category Ajax tabs','storevilla'); ?> </span></li>
                        <li><span><?php _e('Vertical Ajax category with promo image','storevilla'); ?> </span></li>
                        <li><span><?php _e('Special offers/ deals sections','storevilla'); ?> </span></li>
                        <li><span><?php _e('Product list to display popular products','storevilla'); ?> </span></li>
                        <li><span><?php _e('Product lists in column','storevilla'); ?> </span></li>
                        <li><span><?php _e('Full width Promo Widget','storevilla'); ?> </span></li>
                        <li><span><?php _e('Breadcrumbs Settings','storevilla'); ?> </span></li>
                        <li><span><?php _e('Custom CSS Section','storevilla'); ?> </span></li>
                        <li><span><?php _e('Three different blog layouts','storevilla'); ?> </span></li>
                        <li><span><?php _e('Our team member section','storevilla'); ?> </span></li>                        
                        <li><span><?php _e('Testimonial section','storevilla'); ?> </span></li>
                        <li><span><?php _e('Multiple preloader options','storevilla'); ?> </span></li>
                        <li><span><?php _e('Responsive retina ready theme','storevilla'); ?> </span></li>
                        <li><span><?php _e('4 Page layouts (No sidebar, right sidebar, left sidebar, both sidebar)','storevilla'); ?> </span></li>
                        <li><span><?php _e('Fully SEO optimized (schema)','storevilla'); ?> </span></li>
                        <li><span><?php _e('Fast loading','storevilla'); ?> </span></li>
                        <li><span><?php _e('A perfect theme to start your eCommerce store of any kind!','storevilla'); ?> </span></li>
                    </ul>
                    <?php $storevilla_pro_link = 'https://accesspressthemes.com/wordpress-themes/storevilla-pro/'; ?>
                    <a href="<?php echo esc_url($storevilla_pro_link); ?>" class="button button-primary buynow" target="_blank"><?php _e('Buy Now','storevilla'); ?></a>
                </span>
            </label>
            <?php
        }
